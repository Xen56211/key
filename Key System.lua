...
function DarkLib:Window()
	...
	MainFrame.Size = UDim2.new(0, 401, 0, 253)
	...
	Title.Position = UDim2.new(0.250333071, 0, 0.037313275, 0)
	...
	TabHolderFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
	TabHolderFrame.Position = UDim2.new(0.0388656966, 0, 0.469379663, 0)
	TabHolderFrame.Size = UDim2.new(0, 371, 0, 114)
	...
	function Win:Tab(text)
		...
		function Cont:Colorpicker(text, preset, callback)
			...
			Colorpicker.Font = Enum.Font.SciFi
			Colorpicker.Text = ""
			...
			RainbowTitle.Font = Enum.Font.SciFi
